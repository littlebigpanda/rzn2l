...
{ .port = 1, .phylink = ETHER_SELECTOR_PHYLINK_POLARITY_LOW, .interface = ETHER_SELECTOR_INTERFACE_RGMII, .speed =
          ETHER_SELECTOR_SPEED_100MBPS,
...
{ .port_type = ETHER_PHY_PORT_TYPE_ETHER_CAT, .phy_chip = (ether_phy_chip_t) ETHER_PHY_CHIP_KSZ8041, .mdio_type =
          ETHER_PHY_MDIO_GMAC,

  .bps = ETHER_PHY_SPEED_100,
  .duplex = ETHER_PHY_DUPLEX_FULL, .auto_negotiation = ETHER_PHY_AUTO_NEGOTIATION_ON,
...
.channel = 1,
  ...
  .flow_control = ETHER_PHY_FLOW_CONTROL_DISABLE, .mii_type = (ether_phy_mii_type_t) 0,  // Unused
...
{ .port = 0, .phylink = ETHER_SELECTOR_PHYLINK_POLARITY_LOW, .interface = ETHER_SELECTOR_INTERFACE_RGMII, .speed =
          ETHER_SELECTOR_SPEED_100MBPS,
  .duplex = ETHER_SELECTOR_DUPLEX_FULL, .ref_clock = ETHER_SELECTOR_REF_CLOCK_INPUT, .p_extend = NULL, };
...
{ .reset_hold_time = 10, .reset_wait_time = 15000, .offset_address = 0,
